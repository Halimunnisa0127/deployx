...
export default function EmptyState({
  ...
  return (
    <div
      className={`bg-slate-900/60 rounded-2xl border border-slate-800/80 p-8 flex flex-col items-center justify-center text-center shadow-lg ${minHeight} ${className}`}
    >
