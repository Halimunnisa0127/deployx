...
export default function HeroSection() {
  return (
    <section className="relative pt-32 pb-28 lg:pt-44 lg:pb-36 overflow-hidden bg-slate-50 dark:bg-[#0a0a0a]">
      ...
      >
        ...
        <motion.h1 variants={fadeInUp} className="text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-6 leading-[1.1]">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-sky-400 to-blue-700 dark:from-blue-400 dark:via-sky-200 dark:to-blue-500">
            in Minutes
          </span>
        </motion.h1>
