...
export default function HeroSection() {
  return (
    <section className="relative pt-32 pb-28 lg:pt-44 lg:pb-36 overflow-hidden bg-[#0a0a0a]">
      ...
      {/* LAYER 3: Refined Indigo & Purple Ambient Glow Orbs (18–22% Opacity, 150–160px Blur) */}
      {/* Primary Radial Purple & Indigo Glow Orb */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90vw] max-w-[850px] h-[480px] bg-gradient-to-tr from-indigo-600/20 via-purple-600/18 to-transparent rounded-full blur-[160px] pointer-events-none z-0" />
      
      {/* Secondary Soft Upper Indigo Accent Orb */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-2/3 w-[70vw] max-w-[650px] h-[350px] bg-gradient-to-b from-indigo-500/18 via-purple-500/12 to-transparent rounded-full blur-[150px] pointer-events-none z-0" />
      ...
      >
        ...
        <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/[0.04] border border-white/10 text-xs sm:text-sm font-medium text-indigo-300 backdrop-blur-md mb-8 hover:bg-white/[0.08] transition-colors">
          <Sparkles className="w-4 h-4 text-indigo-400" />
          <span>GitHub-powered Deployments</span>
          <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse ml-1" />
        </motion.div>

        {/* Hero Title (Indigo to Purple Gradient) */}
        ...
        <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row justify-center items-center gap-4 max-w-md mx-auto sm:max-w-none">
          <Link 
            to="/register" 
            className="w-full sm:w-auto px-8 py-3.5 text-base font-semibold text-white bg-indigo-600 hover:bg-indigo-500 rounded-xl transition-all shadow-[0_0_30px_rgba(79,70,229,0.35)] hover:shadow-[0_0_40px_rgba(79,70,229,0.55)] flex items-center justify-center gap-2 group"
          >
