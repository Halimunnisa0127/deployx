...
export const MOCK_RECENT_ACTIVITIES = [
  {
    ...
    projectName: 'deployx-frontend',
    description: 'Triggered via main branch update',
    timeAgo: '2 mins ago',
    type: 'deployment',
    filter: 'today',
  },
  {
    ...
    projectName: 'deployx-api-service',
    description: 'Added api.deployx.dev to production',
    timeAgo: '1 hour ago',
    type: 'domain',
    filter: 'today',
  },
  {
    ...
    projectName: 'docs-portal',
    description: 'Push to main branch initiated build',
    timeAgo: 'Yesterday',
    type: 'github',
    filter: 'yesterday',
  },
  ...
  },
  {
    ...
    description: 'Role assigned: Developer',
    timeAgo: '4 days ago',
    type: 'user',
    filter: 'this_week',
  },
...
export const MOCK_GLOBAL_SEARCH_ITEMS = [
  ...
  { id: 'dm1', name: 'api.deployx.dev', category: 'Domains', link: '/dashboard/domains' },
  { id: 'dm2', name: 'app.deployx.dev', category: 'Domains', link: '/dashboard/domains' },
  { id: 'r1', name: 'deployx/frontend', category: 'Repositories', link: '/dashboard/projects/import' },
  { id: 'r2', name: 'deployx/api-service', category: 'Repositories', link: '/dashboard/projects/import' },
  { id: 't1', name: 'Engineering Team', category: 'Teams', link: '/dashboard/settings/team' },
  { id: 'l1', name: 'Production Build Logs', category: 'Logs', link: '/dashboard/deployments' },
];
