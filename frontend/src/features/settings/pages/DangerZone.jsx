...
export default function DangerZone() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {/* Main Container */}
      <div className="bg-slate-900/60 border border-rose-500/30 rounded-2xl p-6 backdrop-blur-xl shadow-xl space-y-8">
        ...
        <form onSubmit={handleTransfer} className="p-5 rounded-2xl bg-slate-950/60 border border-slate-800 space-y-4">
        ...
        <div className="p-5 rounded-2xl bg-rose-950/20 border border-rose-500/30 space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                Permanently delete your account, associated projects, active deployments, custom domains, and build history. This action <span className="font-bold text-rose-400">cannot be undone</span>.
              </p>
            </div>
          </div>
      ...
      >
        <div className="space-y-4 pt-1">
          <div className="p-3.5 rounded-xl bg-rose-950/60 border border-rose-500/40 text-xs text-rose-200 leading-relaxed space-y-1">
          ...
          <div className="space-y-1.5">
            <label className="text-xs text-slate-300 font-medium">
              To confirm, type <span className="font-mono font-bold text-rose-400">DELETE</span> below:
            </label>
            <Input
              placeholder="DELETE"
