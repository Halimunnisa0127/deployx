  ...
  return (
    <div className="w-full max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12 px-4">
      ...
      <div className="text-center space-y-4 pt-10 pb-6">
        ...
        <p className="text-muted-foreground max-w-xl mx-auto text-lg transition-colors">
      ...
      <div className="grid md:grid-cols-3 gap-8 items-stretch">
        {/* Free Tier Card */}
        <div className="p-8 rounded-3xl bg-white/60 dark:bg-slate-900/50 border border-border backdrop-blur-sm relative overflow-hidden transition-all duration-300 hover:scale-[1.02] hover:bg-gradient-to-b hover:from-indigo-50/50 dark:hover:from-indigo-900/40 hover:to-white dark:hover:to-slate-900/80 hover:border-indigo-300 dark:hover:border-indigo-400/60 hover:shadow-[0_0_40px_-10px_rgba(99,102,241,0.3)] group cursor-pointer h-full flex flex-col shadow-sm dark:shadow-none">
          <div className="mb-6">
            <h3 className="text-xl font-bold text-foreground mb-2 transition-colors">Hobby</h3>
            <p className="text-muted-foreground text-sm transition-colors">For personal projects and exploration.</p>
          </div>
          <div className="mb-8">
            <span className="text-4xl font-extrabold text-foreground transition-colors">$0</span>
          ...
          <ul className="space-y-4 mb-8">
            {[
              ...
              <li key={i} className="flex items-center gap-3 text-foreground text-sm transition-colors">
          ...
          <Button variant="outline" fullWidth className="py-2.5 text-foreground border-border hover:bg-slate-100 dark:hover:bg-slate-800 mt-auto transition-colors" disabled>
            Current Plan
          </Button>
        </div>
        ...
        <div className="p-8 rounded-3xl bg-white/60 dark:bg-slate-900/50 border border-border backdrop-blur-sm relative overflow-hidden transition-all duration-300 hover:scale-[1.02] hover:bg-gradient-to-b hover:from-indigo-50/50 dark:hover:from-indigo-900/40 hover:to-white dark:hover:to-slate-900/80 hover:border-indigo-300 dark:hover:border-indigo-400/60 hover:shadow-[0_0_40px_-10px_rgba(99,102,241,0.3)] group cursor-pointer h-full flex flex-col shadow-sm dark:shadow-none">
          ...
          <div className="mb-6 relative z-10">
            <h3 className="text-2xl font-extrabold text-foreground mb-2 flex items-center gap-2 transition-colors">
          ...
          <div className="mb-8 relative z-10">
            <span className="text-4xl font-extrabold text-foreground transition-colors">$19</span>
          ...
          <ul className="space-y-4 mb-8 relative z-10">
            {[
              ...
              <li key={i} className="flex items-center gap-3 text-foreground text-sm font-medium transition-colors">
        ...
        <div className="p-8 rounded-3xl bg-white/60 dark:bg-slate-900/50 border border-border backdrop-blur-sm relative overflow-hidden transition-all duration-300 hover:scale-[1.02] hover:bg-gradient-to-b hover:from-indigo-50/50 dark:hover:from-indigo-900/40 hover:to-white dark:hover:to-slate-900/80 hover:border-indigo-300 dark:hover:border-indigo-400/60 hover:shadow-[0_0_40px_-10px_rgba(99,102,241,0.3)] group cursor-pointer h-full flex flex-col shadow-sm dark:shadow-none">
          <div className="mb-6">
            <h3 className="text-xl font-bold text-foreground mb-2 transition-colors">Enterprise</h3>
            <p className="text-muted-foreground text-sm transition-colors">Custom solutions for large organizations.</p>
          </div>
          <div className="mb-8">
            <span className="text-4xl font-extrabold text-foreground transition-colors">Custom</span>
          </div>
          ...
          <Button variant="outline" fullWidth className="py-2.5 text-foreground border-border hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors mt-auto">
            Contact Sales
          </Button>
        </div>
      </div>
