...
export default function BuildLogToolbar({
  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center justify-between px-4 py-3 border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-[#0b0d12] gap-3 select-none">
      ...
      <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap">
        ...
        <button
          ...
          className="p-1.5 px-2.5 rounded-lg bg-slate-100 dark:bg-slate-800/80 hover:bg-slate-200 dark:hover:bg-slate-700/80 text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-colors text-xs flex items-center gap-1.5 border border-slate-200 dark:border-slate-700/60"
        ...
        <button
          ...
          className={`p-1.5 px-2.5 rounded-lg text-xs flex items-center gap-1.5 border transition-colors ${
            isWordWrap
              ? 'bg-indigo-100 dark:bg-indigo-600/20 text-indigo-700 dark:text-indigo-300 border-indigo-300 dark:border-indigo-500/40 font-medium'
              : 'bg-slate-100 dark:bg-slate-800/80 text-slate-500 dark:text-slate-400 border-slate-200 dark:border-slate-700/60 hover:text-slate-800 dark:hover:text-slate-200'
          }`}
          title={isWordWrap ? 'Disable Word Wrap' : 'Enable Word Wrap'}
        >
          <WrapText className={`w-3.5 h-3.5 ${isWordWrap ? 'text-indigo-600 dark:text-indigo-400' : ''}`} />
        ...
        <button
          type="button"
          onClick={onClearLogs}
          className="p-1.5 px-2.5 rounded-lg bg-slate-100 dark:bg-slate-800/80 hover:bg-rose-50 dark:hover:bg-rose-500/20 hover:text-rose-600 dark:hover:text-rose-300 text-slate-500 dark:text-slate-400 border border-slate-200 dark:border-slate-700/60 transition-colors text-xs flex items-center gap-1.5"
