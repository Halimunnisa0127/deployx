      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-2 pt-0.5 font-mono text-xs">
            ...
            <span className="text-slate-600 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 px-2 py-0.5 rounded border border-slate-200 dark:border-slate-700/60">
              {commitHash}
            </span>
          </div>
        </div>
        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-2 pt-0.5">
            ...
            <span className="text-xs font-medium text-slate-600 dark:text-slate-300 bg-slate-100 dark:bg-slate-800/60 px-2 py-0.5 rounded border border-slate-200 dark:border-slate-700/50 flex items-center gap-1">
        ...
        <div className="space-y-1">
          ...
          <div className="text-sm font-semibold text-slate-900 dark:text-white flex items-center gap-1.5 pt-0.5">
