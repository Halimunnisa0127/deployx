  ...
  return (
    <div className="p-6 rounded-2xl bg-card border border-border shadow-sm space-y-6 text-left">
      <div className="flex items-center justify-between pb-3 border-b border-border">
        ...
        <span className="text-xs text-muted-foreground font-medium font-mono bg-muted px-2.5 py-1 rounded-md border border-border">
      ...
      <div className="divide-y divide-border border border-border rounded-xl overflow-hidden bg-background">
        {artifacts.map((artifact) => {
          ...
          return (
            <div
              key={artifact.id}
              className="p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:bg-muted transition-colors"
            >
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0 space-y-1">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <span className="text-sm font-mono text-muted-foreground bg-muted px-2 py-0.5 rounded border border-border">
                      {artifact.size}
                    </span>
                  </div>
