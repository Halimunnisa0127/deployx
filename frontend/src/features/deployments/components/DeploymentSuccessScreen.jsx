...
export default function DeploymentSuccessScreen({
  ...
  return (
    <div className="w-full max-w-3xl mx-auto space-y-6 animate-fade-in font-sans selection:bg-blue-500 selection:text-white relative">
      ...
      {/* Main Success Card */}
      <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 sm:p-10 shadow-2xl backdrop-blur-xl space-y-8 relative overflow-hidden text-center">
        ...
        <div className="flex flex-col items-center justify-center space-y-3 relative z-10">
          ...
          <div className="space-y-1 max-w-md mx-auto">
            <span className="px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs font-semibold tracking-wide inline-flex items-center gap-1.5">
            ...
            <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
              Your application <span className="text-slate-200 font-bold">{projectName}</span> has been deployed successfully to DeployX global edge network.
            </p>
          </div>
        </div>
        ...
        <div className="p-5 rounded-2xl bg-slate-950/70 border border-slate-800 text-left space-y-4 shadow-inner relative z-10">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-center gap-2 bg-slate-900 p-2.5 rounded-xl border border-slate-800">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="font-mono text-sm text-blue-400 hover:text-blue-300 font-bold truncate flex-1 flex items-center gap-1.5"
              >
                {productionUrl}
          ...
          <div className="space-y-1">
            ...
            <div className="bg-slate-900/60 px-3 py-2 rounded-lg border border-slate-800/80 flex items-center justify-between text-xs">
              <a
                href={previewUrl}
                target="_blank"
                rel="noreferrer"
                className="font-mono text-slate-300 hover:text-white truncate"
              >
                {previewUrl}
              </a>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-left relative z-10">
          ...
          <div className="p-3.5 rounded-xl bg-slate-950/60 border border-slate-800 flex items-center justify-between">
            ...
            <span className="font-mono text-slate-200 font-semibold">{repository}</span>
          </div>
          ...
          <div className="p-3.5 rounded-xl bg-slate-950/60 border border-slate-800 flex items-center justify-between">
            ...
            <span className="font-mono text-blue-400 font-bold">{deploymentId}</span>
          </div>
          ...
          <div className="p-3.5 rounded-xl bg-slate-950/60 border border-slate-800 flex items-center justify-between">
            ...
            <span className="font-mono text-emerald-400 font-bold">{deploymentDuration}</span>
          </div>
        </div>

        {/* 4. Action Buttons Footer */}
        <div className="pt-4 border-t border-slate-800/80 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 relative z-10">
          <Button
            type="button"
            variant="primary"
            size="md"
