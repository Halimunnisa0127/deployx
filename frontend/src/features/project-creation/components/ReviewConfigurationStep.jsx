    ...
    <div className="space-y-5 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs max-h-[340px] overflow-y-auto pr-1 scrollbar-thin scrollbar-thumb-slate-800">
        ...
        <div className="p-4 rounded-xl bg-slate-950/70 border border-slate-800 space-y-3">
          <div className="flex items-center gap-2 font-semibold text-slate-200 text-xs border-b border-slate-800/80 pb-2">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold text-slate-100">{projectName || 'my-app'}</span>
            </div>
        ...
        <div className="p-4 rounded-xl bg-slate-950/70 border border-slate-800 space-y-3">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-mono text-slate-300">{rootDirectory || '/'}</span>
            </div>

            <div className="flex items-center justify-between">
              <span className="text-slate-400">Node Version:</span>
              <span className="font-mono text-slate-300">Node {nodeVersion}</span>
            </div>
        ...
        <div className="p-4 rounded-xl bg-slate-950/70 border border-slate-800 space-y-3">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-slate-400">Install Command:</span>
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-mono text-blue-300 bg-slate-900 px-2 py-0.5 rounded border border-slate-800">
                {outputDirectory}
              </span>
            </div>
          </div>
