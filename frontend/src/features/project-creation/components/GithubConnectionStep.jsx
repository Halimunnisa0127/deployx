    ...
    <div className="space-y-6 animate-fade-in">
      ...
      {!isGithubConnected ? (
        <div className="space-y-6 pt-2">
          <div className="bg-slate-950/60 border border-slate-800/90 rounded-2xl p-6 sm:p-8 text-center flex flex-col items-center justify-center space-y-4 shadow-inner relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-32 h-32 bg-blue-500/10 rounded-full blur-2xl pointer-events-none" />
            <div className="relative">
              <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-700/80 flex items-center justify-center shadow-xl text-slate-100 group-hover:scale-105 transition-transform duration-300">
            ...
            <Button
              ...
              iconLeft={<GithubIcon className="w-5 h-5 text-white" />}
          ...
          <div className="p-4 rounded-xl bg-slate-950/40 border border-slate-800/80 space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-slate-400">
              <div className="flex items-center gap-2 bg-slate-900/50 p-2 rounded-lg border border-slate-800/50">
        ...
        <div className="space-y-4 pt-1">
          <div className="p-3 rounded-xl bg-slate-950/60 border border-slate-800/80 flex items-center justify-between gap-3 text-xs">
            <div className="flex items-center gap-2.5">
              <div className="w-6 h-6 rounded-full bg-slate-800 flex items-center justify-center text-slate-200">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-slate-950/80 border border-slate-800 text-slate-100 text-xs placeholder:text-slate-500 focus:outline-none focus:border-blue-500 transition-colors"
            />
            {repoSearchQuery && (
              <button
          ...
          <div className="space-y-2.5 max-h-[260px] overflow-y-auto pr-1 scrollbar-thin scrollbar-thumb-slate-800">
            {filteredRepositories.length === 0 ? (
              <div className="p-8 text-center bg-slate-950/40 border border-slate-800/80 rounded-xl space-y-2">
                <p className="text-xs text-slate-400">No repositories found matching "{repoSearchQuery}"</p>
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => setRepoSearchQuery('')}
                ...
                return (
                  <div
                    ...
                    className={`p-3.5 rounded-xl border transition-all cursor-pointer flex flex-col gap-2 ${
                      isSelected
                        ? 'bg-blue-500/10 border-blue-500 text-slate-100 shadow-md ring-1 ring-blue-500/30'
                        : 'bg-slate-950/50 border-slate-800/90 text-slate-300 hover:border-slate-700 hover:bg-slate-950/80'
                    }`}
                  >
          ...
          {selectedRepo && (
            <div className="p-3.5 rounded-xl bg-slate-950/80 border border-blue-500/30 space-y-2.5 animate-fade-in">
