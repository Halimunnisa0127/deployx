...
export default function DomainsTable({
  ...
  return (
    <div className="bg-card rounded-2xl border border-border overflow-hidden shadow-lg animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="overflow-x-auto min-h-[400px]">
        <table className="w-full text-left text-sm whitespace-nowrap">
          <thead className="bg-slate-50/90 dark:bg-slate-900/90 text-muted-foreground border-b border-border sticky top-0 z-10 backdrop-blur-xl">
            <tr>
      ...
      {totalPages > 1 && (
        <div className="px-5 py-4 border-t border-border flex items-center justify-between text-sm bg-slate-50 dark:bg-slate-900/40">
