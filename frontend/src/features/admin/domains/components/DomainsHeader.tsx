...
import { Globe, Search, Filter, RefreshCw } from 'lucide-react';
import Button from '../../../../components/ui/Button';

export default function DomainsHeader({ onRefresh, isRefreshing }) {
  return (
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800/60 pb-6">
      <div>
        ...
        <p className="text-sm text-slate-400 mt-1.5 leading-relaxed">
          Manage every custom domain connected across the DeployX platform from one centralized dashboard.
        </p>
      </div>
