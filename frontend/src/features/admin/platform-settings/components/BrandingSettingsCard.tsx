...
export default function BrandingSettingsCard({ register, watch }) {
  ...
  return (
    <div id="branding" className="bg-slate-900/60 rounded-2xl border border-slate-800/80 p-6 shadow-lg">
      <div className="mb-6 border-b border-slate-800/80 pb-4">
        <h2 className="text-lg font-bold text-white">Branding</h2>
        <p className="text-sm text-slate-400">Customize the visual identity of the platform.</p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="flex-1 space-y-6">
          {/* File inputs mock */}
          <div>
            <label className="block text-sm font-medium text-slate-300 mb-1.5">Primary Logo</label>
        ...
        <div className="w-full lg:w-72 shrink-0">
          <label className="block text-sm font-medium text-slate-300 mb-1.5">Live Preview</label>
          <div className="border border-slate-700 rounded-xl bg-slate-950 p-4 h-48 flex flex-col items-center justify-center relative overflow-hidden">
            <div className="w-full max-w-[180px] bg-slate-900 border border-slate-800 rounded-lg shadow-2xl p-4 flex flex-col gap-3 relative z-10">
              <div className="text-center font-bold text-white text-sm truncate">{platformName}</div>
