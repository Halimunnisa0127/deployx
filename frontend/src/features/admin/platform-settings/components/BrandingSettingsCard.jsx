      ...
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="flex-1 space-y-6">
          ...
          <div>
            ...
            <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-border border-dashed rounded-xl hover:border-indigo-500/50 transition-colors bg-slate-50 dark:bg-slate-900/50">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <Input
                {...register("branding.accentColor")}
                className="w-32 bg-card border-border font-mono"
              />
            </div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-72 shrink-0">
          ...
          <div className="border border-border rounded-xl bg-slate-100 dark:bg-slate-950 p-4 h-48 flex flex-col items-center justify-center relative overflow-hidden">
            <div className="w-full max-w-[180px] bg-card border border-border rounded-lg shadow-xl dark:shadow-2xl p-4 flex flex-col gap-3 relative z-10">
              <div className="text-center font-bold text-foreground text-sm truncate">
                {platformName}
              </div>
