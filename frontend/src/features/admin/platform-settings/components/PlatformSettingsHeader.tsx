    ...
    <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 border-b border-slate-800/60 pb-6">
      <div>
        <div className="flex items-center gap-2 text-sm text-slate-400 mb-4">
          ...
          <span>&gt;</span>
          <span className="text-slate-200">Platform Settings</span>
        </div>
        ...
        <p className="text-sm text-slate-400 mt-1.5 leading-relaxed max-w-2xl">
          Configure global platform settings, branding, integrations, notifications and security from one centralized dashboard.
        </p>
      </div>

      <div className="flex flex-wrap items-center gap-3 mt-2 md:mt-0">
        <Button variant="secondary" iconLeft={<Upload className="w-4 h-4" />} onClick={onImport}>
          Import
        </Button>
