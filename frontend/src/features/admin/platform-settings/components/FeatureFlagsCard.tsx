...
export default function FeatureFlagsCard({ watch, setValue }) {
  ...
  return (
    <div id="features" className="bg-slate-900/60 rounded-2xl border border-slate-800/80 p-6 shadow-lg">
      <div className="mb-6 border-b border-slate-800/80 pb-4">
        <h2 className="text-lg font-bold text-white">Feature Flags</h2>
        <p className="text-sm text-slate-400">Enable or disable specific functionality across the platform.</p>
      </div>
