...
import ConfirmationDialog from '../../../../components/ui/ConfirmationDialog'; // Reuse existing generic confirmation if needed
  ...
  return (
    <div className="pb-24 animate-in fade-in duration-300">
      ...
      {error ? (
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-8 flex flex-col lg:flex-row gap-8 relative items-start">
          
          {/* Sidebar Navigation */}
          <div className="w-full lg:w-64 shrink-0 order-last lg:order-first">
            <SettingsNavigation activeSection={activeSection} onSectionChange={scrollToSection} />
          </div>
          ...
          <div className="flex-1 space-y-10 min-w-0">
            ...
            <MaintenanceSettingsCard register={register} watch={watch} setValue={setValue} />
            <FeatureFlagsCard watch={watch} setValue={setValue} />
            <EmailSettingsCard register={register} errors={errors} onTestEmail={handleTestEmail} />
            <SecuritySettingsCard register={register} watch={watch} setValue={setValue} />
          </div>
