...
export function NoProjectsEmptyState() {
  return (
    <div className="bg-slate-900/60 rounded-2xl border border-slate-800/80 p-10 flex flex-col items-center justify-center text-center">
      ...
      <p className="text-slate-400 max-w-sm mb-6">There are currently no projects in the platform.</p>
    </div>
  );
}
...
export function NoSearchResultsEmptyState({ onClear }) {
  return (
    <div className="bg-slate-900/60 rounded-2xl border border-slate-800/80 p-10 flex flex-col items-center justify-center text-center">
      ...
      <p className="text-slate-400 max-w-sm mb-6">No projects matched your search or filter criteria. Try adjusting them.</p>
...
export function NoActiveProjectsEmptyState({ onClear }) {
  return (
    <div className="bg-slate-900/60 rounded-2xl border border-slate-800/80 p-10 flex flex-col items-center justify-center text-center">
      ...
      <p className="text-slate-400 max-w-sm mb-6">There are currently no active projects on the platform.</p>
      <Button variant="secondary" onClick={onClear}>Clear Filters</Button>
    </div>
  );
}
...
export function NoArchivedProjectsEmptyState({ onClear }) {
  return (
    <div className="bg-slate-900/60 rounded-2xl border border-slate-800/80 p-10 flex flex-col items-center justify-center text-center">
      ...
      <h3 className="text-xl font-bold text-white mb-2">No Archived Projects</h3>
      <p className="text-slate-400 max-w-sm mb-6">There are currently no archived projects on the platform.</p>
      <Button variant="secondary" onClick={onClear}>Clear Filters</Button>
    </div>
  );
}
