...
export default function ProjectsHeader({ onExport }) {
  return (
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800/60 pb-6">
      <div>
        ...
        <p className="text-sm text-slate-400 mt-1.5 leading-relaxed">
          Manage every project across the DeployX platform from one centralized dashboard.
        </p>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <Button variant="primary" iconLeft={<Download className="w-4 h-4" />} onClick={onExport}>
          Export
        </Button>
      </div>
    </div>
