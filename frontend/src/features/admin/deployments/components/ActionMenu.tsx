...
import { MoreVertical, Info, FolderGit2, Terminal, Globe, RefreshCcw, XCircle, Trash2, Copy, ExternalLink } from 'lucide-react';
import Dropdown from '../../../../components/ui/Dropdown';

export default function ActionMenu({ deployment, onViewDetails, onOpenProject, onRedeploy, onCancel, onDelete }) {
