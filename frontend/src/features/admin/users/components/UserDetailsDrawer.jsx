          ...
          <div className="bg-slate-900/40 rounded-xl border border-slate-800/80 p-1">
            {user.recentProjects?.length > 0 ? (
              user.recentProjects.map((proj, idx) => (
                <div
                  key={idx}
                  className="px-4 py-3 border-b border-slate-800/50 last:border-0 text-sm text-slate-300 font-medium"
                >
                  {proj}
                </div>
              ))
          ...
          <div className="bg-slate-900/40 rounded-xl border border-slate-800/80 p-1">
            {user.recentDeployments?.length > 0 ? (
              user.recentDeployments.map((dep, idx) => (
                <div
                  key={idx}
                  className="px-4 py-3 border-b border-slate-800/50 last:border-0 text-sm text-slate-300 font-mono"
                >
                  {dep}
                </div>
              ))
