...
import { OverviewSkeleton, InfraSkeleton, MetricSkeleton } from '../components/SystemHealthSkeleton';
...
export default function SystemHealthPage() {
  ...
  const fetchData = useCallback(async (isRefresh = false) => {
    try {
      ...
      const [overviewRes, infraRes, metricsRes, incidentsRes] = await Promise.all([
        getSystemOverview(),
        getInfrastructureStatus(),
        getPerformanceMetrics(),
        getIncidentTimeline()
