...
export function NoDeploymentsEmptyState() {
  return (
    <div className="bg-slate-900/60 rounded-2xl border border-slate-800/80 p-10 flex flex-col items-center justify-center text-center">
      ...
      <p className="text-slate-400 max-w-sm mb-6">There are no recent deployments to display on the platform.</p>
...
export function NoUsersEmptyState() {
  return (
    <div className="bg-slate-900/60 rounded-2xl border border-slate-800/80 p-10 flex flex-col items-center justify-center text-center">
      ...
      <p className="text-slate-400 max-w-sm mb-6">There are no recent users to display on the platform.</p>
...
export function NoActivityEmptyState() {
  return (
    <div className="bg-slate-900/60 rounded-2xl border border-slate-800/80 p-10 flex flex-col items-center justify-center text-center h-full">
      ...
      <h3 className="text-lg font-bold text-white mb-2">No Activity</h3>
      <p className="text-slate-400 max-w-sm">There has been no recent activity recorded on the platform.</p>
    </div>
  );
}
