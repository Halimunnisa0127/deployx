  ...
  return (
    <div className="bg-slate-900/60 rounded-2xl border border-slate-800/80 overflow-hidden shadow-lg">
      <div className="p-5 border-b border-slate-800/80 flex items-center justify-between">
        <h3 className="text-lg font-bold text-white tracking-tight">Recent Deployments</h3>
      </div>
              ...
              <tr key={dep.id} className="group hover:bg-slate-800/30 transition-colors">
                <td className="px-5 py-4">
                  <div className="flex items-center gap-2">
                    <span className="font-bold text-white group-hover:text-indigo-300 transition-colors">{dep.project}</span>
                    <span className="font-mono text-xs text-indigo-400 bg-indigo-500/10 px-2 py-0.5 rounded border border-indigo-500/20">{dep.id}</span>
                  </div>
                </td>
                <td className="px-5 py-4">
                ...
                <td className="px-5 py-4 text-right">
                  <Button variant="ghost" size="sm" iconLeft={<Eye className="w-4 h-4 text-indigo-400" />} className="text-slate-300 hover:text-white">
                    View
                  </Button>
                </td>
              </tr>
