...
export default function OverviewCard({ title, value, change, icon: Icon, onClick }) {
  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-4">
        ...
        <div className="w-8 h-8 rounded-lg flex items-center justify-center text-slate-500 group-hover:text-indigo-400 group-hover:bg-indigo-500/10 transition-colors">
      ...
      <div>
        ...
        <div className="flex items-end gap-3">
          ...
          {!isNeutral && (
            <div className={`flex items-center text-xs font-medium mb-1 px-1.5 py-0.5 rounded ${isPositive ? 'text-emerald-400 bg-emerald-500/10 border border-emerald-500/20' : 'text-rose-400 bg-rose-500/10 border border-rose-500/20'}`}>
