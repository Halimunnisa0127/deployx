...
export default function AnalyticsHeader({ onRefresh, onExport, isRefreshing, dateRange, setDateRange }) {
  return (
    <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 border-b border-slate-800/60 pb-6">
      <div>
        ...
        <p className="text-sm text-slate-400 mt-1.5 leading-relaxed max-w-2xl">
          Monitor platform usage, growth, infrastructure metrics, deployment performance and business insights.
        </p>
      </div>
