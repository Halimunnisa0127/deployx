  ...
  return (
    <div className="bg-slate-900/60 rounded-2xl border border-slate-800/80 p-5 shadow-lg h-[350px] flex flex-col">
      <div className="mb-4">
        ...
        <p className="text-sm text-slate-400">Total deployments across all projects</p>
      </div>
      <div className="flex-1 min-h-0">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={data} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
            ...
            />
            <Area type="monotone" dataKey="deployments" stroke="#6366f1" strokeWidth={3} fillOpacity={1} fill="url(#colorDeployments)" />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </div>
