    ...
    >
      ...
      <div className="pt-3 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs text-slate-400 border-t border-slate-800/50">
        <div className="flex items-center gap-4 flex-wrap">
          <span className="inline-flex items-center gap-1.5 text-slate-400">
            Connected Project: <strong className="text-slate-300 font-medium">{projectName}</strong>
          </span>

          <span className="inline-flex items-center gap-1.5 text-slate-400">
            <User className="w-3.5 h-3.5 text-slate-500 shrink-0" />
            Created by: <strong className="text-slate-300 font-medium">{createdBy}</strong>
          </span>

          <span className="inline-flex items-center gap-1.5 text-slate-400">
            Last Updated: <strong className="text-slate-300 font-medium">{updatedAt}</strong>
          </span>
        </div>
